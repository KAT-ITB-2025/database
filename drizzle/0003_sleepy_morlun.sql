...
ALTER TABLE "peserta_kelas" ADD CONSTRAINT "peserta_kelas_kelas_id_kelas_id_kelas_fk" FOREIGN KEY ("kelas_id") REFERENCES "public"."kelas"("id_kelas") ON DELETE cascade ON UPDATE no action;